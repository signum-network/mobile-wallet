...
type NoAccountNavProp = CompositeNavigationProp<
  StackNavigationProp<ReceiveStackParamList, 'Receive'>,
  BottomTabNavigationProp<BottomTabNavigatorParamList, 'ReceiveStack'>
>;

export const NoAccount = () => {
  const navigation = useNavigation<NoAccountNavProp>();
